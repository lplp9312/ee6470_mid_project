...
// Generated on: May  5 2021 02:09:06 CST (May  4 2021 18:09:06 UTC)

module DC_Filter_Add2i125Mul2i258Add2u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  CLKINVX2 g10(.A (out1[7]), .Y (out1[6]));
  ...
  NOR2X2 csa_tree_add_32_2_groupi_g158(.A (out1[9]), .B (out1[10]), .Y
