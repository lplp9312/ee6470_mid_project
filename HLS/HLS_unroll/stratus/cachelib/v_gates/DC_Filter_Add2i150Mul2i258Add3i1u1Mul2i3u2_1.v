...
// Generated on: May  5 2021 02:03:57 CST (May  4 2021 18:03:57 UTC)

module DC_Filter_Add2i150Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  NAND2BX1 csa_tree_add_35_2_groupi_g176(.AN
       (csa_tree_add_35_2_groupi_n_9), .B (out1[5]), .Y (out1[4]));
