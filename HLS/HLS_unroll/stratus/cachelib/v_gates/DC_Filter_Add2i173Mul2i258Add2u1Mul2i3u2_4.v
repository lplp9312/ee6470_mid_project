...
// Generated on: May  5 2021 01:59:01 CST (May  4 2021 17:59:01 UTC)

module DC_Filter_Add2i173Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XNOR2X1 csa_tree_add_32_2_groupi_g87(.A (out1[11]), .B
       (csa_tree_add_32_2_groupi_n_2), .Y (out1[4]));
  NAND2BX1 csa_tree_add_32_2_groupi_g88(.AN
       (csa_tree_add_32_2_groupi_n_2), .B (out1[11]), .Y (out1[5]));
  AO21XL csa_tree_add_32_2_groupi_g89(.A0 (out1[10]), .A1 (out1[9]),
       .B0 (csa_tree_add_32_2_groupi_n_2), .Y (out1[3]));
  NOR2X1 csa_tree_add_32_2_groupi_g90(.A (out1[10]), .B (out1[9]), .Y
       (csa_tree_add_32_2_groupi_n_2));
endmodule
