...
// Generated on: May  5 2021 01:57:44 CST (May  4 2021 17:57:44 UTC)

module DC_Filter_Add2i169Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XOR2XL csa_tree_add_35_2_groupi_g78(.A (out1[11]), .B (out1[10]), .Y
       (out1[4]));
  NAND2X1 csa_tree_add_35_2_groupi_g79(.A (out1[11]), .B (out1[10]), .Y
       (out1[5]));
