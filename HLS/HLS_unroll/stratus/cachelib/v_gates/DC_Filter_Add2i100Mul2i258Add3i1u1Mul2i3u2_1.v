...
// Generated on: May  5 2021 02:04:35 CST (May  4 2021 18:04:35 UTC)

module DC_Filter_Add2i100Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  NAND2X4 csa_tree_add_35_2_groupi_g156(.A (out1[11]), .B
       (csa_tree_add_35_2_groupi_n_3), .Y (out1[6]));
  ADDHX1 csa_tree_add_35_2_groupi_g157(.A (out1[10]), .B (out1[9]), .CO
       (csa_tree_add_35_2_groupi_n_3), .S (out1[3]));
  INVXL csa_tree_add_35_2_groupi_g158(.A (out1[11]), .Y
