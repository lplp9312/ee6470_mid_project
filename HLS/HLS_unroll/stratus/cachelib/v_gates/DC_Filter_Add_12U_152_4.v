...
module DC_Filter_Add_12U_152_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g274(.AN (add_21_2_n_10), .B (in1[7]), .Y
       (add_21_2_n_12));
  XNOR2X1 add_21_2_g275(.A (in1[6]), .B (add_21_2_n_8), .Y (out1[6]));
  NAND2BX1 add_21_2_g276(.AN (add_21_2_n_8), .B (in1[6]), .Y
       (add_21_2_n_10));
  AO21XL add_21_2_g277(.A0 (in1[5]), .A1 (add_21_2_n_7), .B0
       (add_21_2_n_8), .Y (out1[5]));
  NOR2X1 add_21_2_g278(.A (in1[5]), .B (add_21_2_n_7), .Y
       (add_21_2_n_8));
  ...
  OAI2BB1X1 add_21_2_g281(.A0N (in1[2]), .A1N (add_21_2_n_0), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g282(.A (in1[2]), .B (add_21_2_n_0), .Y
       (add_21_2_n_2));
  OAI2BB1X1 add_21_2_g283(.A0N (in1[1]), .A1N (in1[0]), .B0
       (add_21_2_n_0), .Y (out1[1]));
  OR2X1 add_21_2_g284(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
