...
// Generated on: May  5 2021 01:53:36 CST (May  4 2021 17:53:36 UTC)

module DC_Filter_Add_12U_125_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g259(.AN (add_21_2_n_7), .B (in1[6]), .Y
       (add_21_2_n_9));
  XNOR2X1 add_21_2_g260(.A (in1[5]), .B (add_21_2_n_5), .Y (out1[5]));
  NAND2BX1 add_21_2_g261(.AN (add_21_2_n_5), .B (in1[5]), .Y
       (add_21_2_n_7));
  XNOR2X1 add_21_2_g262(.A (in1[4]), .B (add_21_2_n_3), .Y (out1[4]));
  NAND2BX1 add_21_2_g263(.AN (add_21_2_n_3), .B (in1[4]), .Y
       (add_21_2_n_5));
  AO21XL add_21_2_g264(.A0 (in1[3]), .A1 (add_21_2_n_1), .B0
       (add_21_2_n_3), .Y (out1[3]));
  NOR2X1 add_21_2_g265(.A (in1[3]), .B (add_21_2_n_1), .Y
       (add_21_2_n_3));
  OAI2BB1X1 add_21_2_g266(.A0N (in1[2]), .A1N (in1[1]), .B0
       (add_21_2_n_1), .Y (out1[2]));
  OR2X1 add_21_2_g267(.A (in1[2]), .B (in1[1]), .Y (add_21_2_n_1));
endmodule
