...
// Generated on: May  5 2021 02:06:32 CST (May  4 2021 18:06:32 UTC)

module DC_Filter_Add2i207Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  wire csa_tree_add_29_2_groupi_n_0, csa_tree_add_29_2_groupi_n_1,
       ...
       csa_tree_add_35_2_groupi_n_5, csa_tree_add_35_2_groupi_n_8;
  assign out1[0] = 1'b1;
  assign out1[6] = 1'b1;
  assign out1[7] = 1'b1;
  ...
  ADDHX1 csa_tree_add_35_2_groupi_g171(.A (out1[11]), .B
       (csa_tree_add_35_2_groupi_n_8), .CO (out1[5]), .S (out1[4]));
