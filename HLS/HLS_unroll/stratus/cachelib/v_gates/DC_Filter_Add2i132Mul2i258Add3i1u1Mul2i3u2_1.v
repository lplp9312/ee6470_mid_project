...
// Generated on: May  5 2021 02:04:11 CST (May  4 2021 18:04:11 UTC)

module DC_Filter_Add2i132Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  ADDHXL csa_tree_add_35_2_groupi_g160(.A (out1[11]), .B
       (csa_tree_add_35_2_groupi_n_1), .CO (out1[5]), .S (out1[4]));
  ADDHXL csa_tree_add_35_2_groupi_g161(.A (out1[10]), .B (out1[9]), .CO
       (csa_tree_add_35_2_groupi_n_1), .S (out1[3]));
endmodule
