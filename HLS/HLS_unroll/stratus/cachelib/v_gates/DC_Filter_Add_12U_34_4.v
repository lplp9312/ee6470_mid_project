...
// Generated on: May  5 2021 01:53:07 CST (May  4 2021 17:53:07 UTC)

module DC_Filter_Add_12U_34_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g266(.A (in1[7]), .B (add_21_2_n_10), .Y
       (add_21_2_n_12));
  OAI2BB1X1 add_21_2_g267(.A0N (in1[6]), .A1N (add_21_2_n_9), .B0
       (add_21_2_n_10), .Y (out1[6]));
  OR2X1 add_21_2_g268(.A (in1[6]), .B (add_21_2_n_9), .Y
       (add_21_2_n_10));
  ADDHX1 add_21_2_g269(.A (in1[5]), .B (add_21_2_n_6), .CO
       (add_21_2_n_9), .S (out1[5]));
  OAI2BB1X1 add_21_2_g270(.A0N (in1[4]), .A1N (add_21_2_n_5), .B0
       (add_21_2_n_6), .Y (out1[4]));
  OR2X1 add_21_2_g271(.A (in1[4]), .B (add_21_2_n_5), .Y
       (add_21_2_n_6));
