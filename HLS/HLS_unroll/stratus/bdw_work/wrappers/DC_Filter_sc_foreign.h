...
#ifndef _DC_FILTER_SC_FOREIGN_INCLUDED_
#define _DC_FILTER_SC_FOREIGN_INCLUDED_
...
struct DC_Filter : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "DC_Filter"; }
...
#endif /* _DC_FILTER_SC_FOREIGN_INCLUDED_ */
