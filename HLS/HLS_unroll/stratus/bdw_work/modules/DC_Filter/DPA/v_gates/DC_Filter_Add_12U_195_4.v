...
// Generated on: May  5 2021 01:54:09 CST (May  4 2021 17:54:09 UTC)

module DC_Filter_Add_12U_195_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g287(.AN (add_21_2_n_10), .B (in1[7]), .Y
       (add_21_2_n_12));
  AO21XL add_21_2_g288(.A0 (in1[6]), .A1 (add_21_2_n_9), .B0
       (add_21_2_n_10), .Y (out1[6]));
  NOR2X1 add_21_2_g289(.A (in1[6]), .B (add_21_2_n_9), .Y
       (add_21_2_n_10));
  ADDHX1 add_21_2_g290(.A (in1[5]), .B (add_21_2_n_6), .CO
       (add_21_2_n_9), .S (out1[5]));
  OAI2BB1X1 add_21_2_g291(.A0N (in1[4]), .A1N (add_21_2_n_5), .B0
       (add_21_2_n_6), .Y (out1[4]));
  OR2X1 add_21_2_g292(.A (in1[4]), .B (add_21_2_n_5), .Y
       (add_21_2_n_6));
  ADDHX1 add_21_2_g293(.A (in1[3]), .B (add_21_2_n_2), .CO
       (add_21_2_n_5), .S (out1[3]));
  ADDHX1 add_21_2_g294(.A (in1[2]), .B (add_21_2_n_0), .CO
       (add_21_2_n_2), .S (out1[2]));
  ADDHX1 add_21_2_g295(.A (in1[1]), .B (in1[0]), .CO (add_21_2_n_0), .S
       (out1[1]));
endmodule
