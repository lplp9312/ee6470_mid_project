...
// Generated on: May  5 2021 01:54:01 CST (May  4 2021 17:54:01 UTC)

module DC_Filter_Add_12U_176_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g259(.AN (add_21_2_n_7), .B (in1[6]), .Y
       (add_21_2_n_9));
  AO21XL add_21_2_g260(.A0 (in1[5]), .A1 (add_21_2_n_5), .B0
       (add_21_2_n_7), .Y (out1[5]));
  NOR2X1 add_21_2_g261(.A (in1[5]), .B (add_21_2_n_5), .Y
       (add_21_2_n_7));
  OAI2BB1X1 add_21_2_g262(.A0N (in1[4]), .A1N (add_21_2_n_3), .B0
       (add_21_2_n_5), .Y (out1[4]));
  OR2X1 add_21_2_g263(.A (in1[4]), .B (add_21_2_n_3), .Y
       (add_21_2_n_5));
  OAI2BB1X1 add_21_2_g264(.A0N (in1[3]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_3), .Y (out1[3]));
  OR2X1 add_21_2_g265(.A (in1[3]), .B (add_21_2_n_1), .Y
       (add_21_2_n_3));
