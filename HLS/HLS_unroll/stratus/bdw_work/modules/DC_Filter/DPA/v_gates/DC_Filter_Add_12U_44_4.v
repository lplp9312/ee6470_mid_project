...
module DC_Filter_Add_12U_44_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g263(.A (in1[7]), .B (add_21_2_n_10), .Y
       (add_21_2_n_12));
  OAI2BB1X1 add_21_2_g264(.A0N (in1[6]), .A1N (add_21_2_n_9), .B0
       (add_21_2_n_10), .Y (out1[6]));
  OR2X1 add_21_2_g265(.A (in1[6]), .B (add_21_2_n_9), .Y
       (add_21_2_n_10));
  ...
  OR2XL add_21_2_g272(.A (in1[2]), .B (add_21_2_n_1), .Y
       (add_21_2_n_2));
