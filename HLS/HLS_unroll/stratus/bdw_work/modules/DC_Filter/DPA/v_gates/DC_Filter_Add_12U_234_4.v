...
module DC_Filter_Add_12U_234_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g272(.AN (add_21_2_n_12), .B (in1[8]), .Y
       (add_21_2_n_14));
  XNOR2X1 add_21_2_g273(.A (in1[7]), .B (add_21_2_n_10), .Y (out1[7]));
  NAND2BX1 add_21_2_g274(.AN (add_21_2_n_10), .B (in1[7]), .Y
       (add_21_2_n_12));
  ...
  OAI2BB1X1 add_21_2_g282(.A0N (in1[2]), .A1N (add_21_2_n_0), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g283(.A (in1[2]), .B (add_21_2_n_0), .Y
       (add_21_2_n_2));
