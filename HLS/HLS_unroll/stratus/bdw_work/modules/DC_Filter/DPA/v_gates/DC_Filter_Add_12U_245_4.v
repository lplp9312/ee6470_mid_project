...
module DC_Filter_Add_12U_245_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  ADDHX1 add_21_2_g263(.A (in1[5]), .B (add_21_2_n_5), .CO
       (add_21_2_n_7), .S (out1[5]));
  ADDHX1 add_21_2_g264(.A (in1[4]), .B (add_21_2_n_3), .CO
       (add_21_2_n_5), .S (out1[4]));
  ADDHX1 add_21_2_g265(.A (in1[3]), .B (add_21_2_n_1), .CO
       (add_21_2_n_3), .S (out1[3]));
  ADDHX1 add_21_2_g266(.A (in1[2]), .B (in1[1]), .CO (add_21_2_n_1), .S
       (out1[2]));
endmodule
