...
module DC_Filter_Add2i116Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  OAI2BB1X1 csa_tree_add_32_2_groupi_g89(.A0N (out1[11]), .A1N
       (csa_tree_add_32_2_groupi_n_2), .B0 (out1[7]), .Y (out1[4]));
  OR2X1 csa_tree_add_32_2_groupi_g90(.A (out1[11]), .B
       (csa_tree_add_32_2_groupi_n_2), .Y (out1[7]));
  ADDHX1 csa_tree_add_32_2_groupi_g91(.A (out1[10]), .B (out1[9]), .CO
