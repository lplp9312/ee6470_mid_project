...
// Generated on: May  5 2021 01:58:14 CST (May  4 2021 17:58:14 UTC)

module DC_Filter_Add2i243Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  NOR2X1 csa_tree_add_32_2_groupi_g125(.A (n_4), .B
       (csa_tree_add_32_2_groupi_n_5), .Y (out1[7]));
  ADDHX1 csa_tree_add_32_2_groupi_g126(.A (n_3), .B
  ...
  AO21XL csa_tree_add_32_2_groupi_g2(.A0 (n_4), .A1
       (csa_tree_add_32_2_groupi_n_5), .B0 (out1[7]), .Y (out1[4]));
endmodule
