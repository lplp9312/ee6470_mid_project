...
module DC_Filter_Add_12U_110_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g273(.AN (add_21_2_n_8), .B (in1[6]), .Y
       (add_21_2_n_10));
  XNOR2X1 add_21_2_g274(.A (in1[5]), .B (add_21_2_n_6), .Y (out1[5]));
  NAND2BX1 add_21_2_g275(.AN (add_21_2_n_6), .B (in1[5]), .Y
       (add_21_2_n_8));
  XNOR2X1 add_21_2_g276(.A (in1[4]), .B (add_21_2_n_4), .Y (out1[4]));
  NAND2BX1 add_21_2_g277(.AN (add_21_2_n_4), .B (in1[4]), .Y
       (add_21_2_n_6));
  XNOR2X1 add_21_2_g278(.A (in1[3]), .B (add_21_2_n_2), .Y (out1[3]));
  NAND2BX1 add_21_2_g279(.AN (add_21_2_n_2), .B (in1[3]), .Y
       (add_21_2_n_4));
  XNOR2X1 add_21_2_g280(.A (in1[2]), .B (add_21_2_n_0), .Y (out1[2]));
  NAND2BX1 add_21_2_g281(.AN (add_21_2_n_0), .B (in1[2]), .Y
       (add_21_2_n_2));
  AO21XL add_21_2_g282(.A0 (in1[1]), .A1 (in1[0]), .B0 (add_21_2_n_0),
       .Y (out1[1]));
  NOR2X1 add_21_2_g283(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
