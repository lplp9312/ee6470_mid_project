...
// Generated on: May  5 2021 00:47:59 CST (May  4 2021 16:47:59 UTC)

module DC_Filter_Add2i179Mul2i258Add2u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  NAND2BX1 csa_tree_add_32_2_groupi_g167(.AN
       (csa_tree_add_32_2_groupi_n_8), .B (out1[6]), .Y (out1[4]));
  OR2X1 csa_tree_add_32_2_groupi_g168(.A (out1[11]), .B
       (csa_tree_add_32_2_groupi_n_6), .Y (out1[6]));
