...
module DC_Filter_Add_12U_225_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g258(.A (in1[6]), .B (add_21_2_n_7), .Y
       (add_21_2_n_9));
  OAI2BB1X1 add_21_2_g259(.A0N (in1[5]), .A1N (add_21_2_n_6), .B0
       (add_21_2_n_7), .Y (out1[5]));
  OR2X1 add_21_2_g260(.A (in1[5]), .B (add_21_2_n_6), .Y
       (add_21_2_n_7));
  ADDHX1 add_21_2_g261(.A (in1[4]), .B (add_21_2_n_3), .CO
       (add_21_2_n_6), .S (out1[4]));
  OAI2BB1X1 add_21_2_g262(.A0N (in1[3]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_3), .Y (out1[3]));
  OR2X1 add_21_2_g263(.A (in1[3]), .B (add_21_2_n_1), .Y
       (add_21_2_n_3));
  OAI2BB1X1 add_21_2_g264(.A0N (in1[2]), .A1N (in1[1]), .B0
       (add_21_2_n_1), .Y (out1[2]));
  OR2X1 add_21_2_g265(.A (in1[2]), .B (in1[1]), .Y (add_21_2_n_1));
endmodule
