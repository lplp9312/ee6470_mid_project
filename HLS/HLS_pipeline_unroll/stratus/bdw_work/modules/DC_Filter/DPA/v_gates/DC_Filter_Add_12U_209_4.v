...
module DC_Filter_Add_12U_209_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g279(.A (in1[6]), .B (add_21_2_n_9), .Y
       (add_21_2_n_10));
  ...
  OR2X1 add_21_2_g282(.A (in1[4]), .B (add_21_2_n_4), .Y
       (add_21_2_n_6));
  OAI2BB1X1 add_21_2_g283(.A0N (in1[3]), .A1N (add_21_2_n_2), .B0
       (add_21_2_n_4), .Y (out1[3]));
  OR2X1 add_21_2_g284(.A (in1[3]), .B (add_21_2_n_2), .Y
       (add_21_2_n_4));
  OAI2BB1X1 add_21_2_g285(.A0N (in1[2]), .A1N (add_21_2_n_0), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g286(.A (in1[2]), .B (add_21_2_n_0), .Y
       (add_21_2_n_2));
  OAI2BB1X1 add_21_2_g287(.A0N (in1[1]), .A1N (in1[0]), .B0
       (add_21_2_n_0), .Y (out1[1]));
  OR2X1 add_21_2_g288(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
