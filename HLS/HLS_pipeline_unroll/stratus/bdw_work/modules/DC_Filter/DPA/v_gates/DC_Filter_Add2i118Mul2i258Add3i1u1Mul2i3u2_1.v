...
// Generated on: May  5 2021 00:43:51 CST (May  4 2021 16:43:51 UTC)

module DC_Filter_Add2i118Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  NAND2BX1 csa_tree_add_35_2_groupi_g177(.AN
       (csa_tree_add_35_2_groupi_n_9), .B (out1[7]), .Y (out1[4]));
  NAND2X2 csa_tree_add_35_2_groupi_g178(.A
       (csa_tree_add_35_2_groupi_n_4), .B
       (csa_tree_add_35_2_groupi_n_7), .Y (out1[7]));
  NOR2X1 csa_tree_add_35_2_groupi_g179(.A
       (csa_tree_add_35_2_groupi_n_4), .B
       (csa_tree_add_35_2_groupi_n_7), .Y
       (csa_tree_add_35_2_groupi_n_9));
  MXI2X1 csa_tree_add_35_2_groupi_g180(.A (out1[10]), .B
       (csa_tree_add_35_2_groupi_n_3), .S0
       (csa_tree_add_35_2_groupi_n_5), .Y (out1[3]));
  NAND2X2 csa_tree_add_35_2_groupi_g181(.A (out1[10]), .B
  ...
  INVX1 csa_tree_add_35_2_groupi_g185(.A (out1[11]), .Y
       (csa_tree_add_35_2_groupi_n_4));
  INVX1 csa_tree_add_35_2_groupi_g186(.A (out1[10]), .Y
       (csa_tree_add_35_2_groupi_n_3));
  INVX1 csa_tree_add_35_2_groupi_g187(.A (out1[8]), .Y
  ...
  INVXL csa_tree_add_35_2_groupi_fopt189(.A
       (csa_tree_add_35_2_groupi_n_18), .Y
       (csa_tree_add_35_2_groupi_n_17));
  INVXL csa_tree_add_35_2_groupi_fopt190(.A (out1[9]), .Y
       (csa_tree_add_35_2_groupi_n_18));
endmodule
