...
module DC_Filter_Add_12U_187_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g274(.AN (add_21_2_n_10), .B (in1[7]), .Y
       (add_21_2_n_12));
  AO21XL add_21_2_g275(.A0 (in1[6]), .A1 (add_21_2_n_9), .B0
       (add_21_2_n_10), .Y (out1[6]));
  NOR2X1 add_21_2_g276(.A (in1[6]), .B (add_21_2_n_9), .Y
       (add_21_2_n_10));
  ...
  OAI2BB1X1 add_21_2_g279(.A0N (in1[3]), .A1N (add_21_2_n_3), .B0
       (add_21_2_n_4), .Y (out1[3]));
  OR2X1 add_21_2_g280(.A (in1[3]), .B (add_21_2_n_3), .Y
       (add_21_2_n_4));
  ADDHX1 add_21_2_g281(.A (in1[2]), .B (add_21_2_n_0), .CO
       (add_21_2_n_3), .S (out1[2]));
  ADDHX1 add_21_2_g282(.A (in1[1]), .B (in1[0]), .CO (add_21_2_n_0), .S
       (out1[1]));
endmodule
