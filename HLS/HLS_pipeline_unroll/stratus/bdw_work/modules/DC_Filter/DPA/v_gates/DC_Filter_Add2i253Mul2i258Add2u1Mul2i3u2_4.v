...
// Generated on: May  5 2021 00:37:43 CST (May  4 2021 16:37:43 UTC)

module DC_Filter_Add2i253Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XNOR2X1 csa_tree_add_32_2_groupi_g120(.A (out1[1]), .B (out1[7]), .Y
       (out1[8]));
  NAND2BX1 csa_tree_add_32_2_groupi_g121(.AN (out1[7]), .B (out1[1]),
       .Y (csa_tree_add_32_2_groupi_n_5));
  NOR2X1 csa_tree_add_32_2_groupi_g124(.A (n_4), .B
       (csa_tree_add_32_2_groupi_n_2), .Y (out1[7]));
  OAI2BB1X1 csa_tree_add_32_2_groupi_g125(.A0N (n_3), .A1N (n_2), .B0
       (csa_tree_add_32_2_groupi_n_2), .Y (out1[3]));
  OR2X1 csa_tree_add_32_2_groupi_g126(.A (n_3), .B (n_2), .Y
       (csa_tree_add_32_2_groupi_n_2));
  AO21XL csa_tree_add_32_2_groupi_g2(.A0 (n_4), .A1
       (csa_tree_add_32_2_groupi_n_2), .B0 (out1[7]), .Y (out1[4]));
