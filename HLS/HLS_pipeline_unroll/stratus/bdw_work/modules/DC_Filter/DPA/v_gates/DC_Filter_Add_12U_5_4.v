...
module DC_Filter_Add_12U_5_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g269(.AN (add_21_2_n_12), .B (in1[8]), .Y
       (add_21_2_n_14));
  AO21XL add_21_2_g270(.A0 (in1[7]), .A1 (add_21_2_n_11), .B0
       (add_21_2_n_12), .Y (out1[7]));
  NOR2XL add_21_2_g271(.A (in1[7]), .B (add_21_2_n_11), .Y
       (add_21_2_n_12));
  ADDHX1 add_21_2_g272(.A (in1[6]), .B (add_21_2_n_8), .CO
  ...
  OR2X1 add_21_2_g276(.A (in1[4]), .B (add_21_2_n_5), .Y
       (add_21_2_n_6));
  ADDHX1 add_21_2_g277(.A (in1[3]), .B (add_21_2_n_2), .CO
       (add_21_2_n_5), .S (out1[3]));
  OAI2BB1X1 add_21_2_g278(.A0N (in1[2]), .A1N (add_21_2_n_0), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g279(.A (in1[2]), .B (add_21_2_n_0), .Y
       (add_21_2_n_2));
  OAI2BB1X1 add_21_2_g280(.A0N (in1[1]), .A1N (in1[0]), .B0
       (add_21_2_n_0), .Y (out1[1]));
  OR2X1 add_21_2_g281(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
