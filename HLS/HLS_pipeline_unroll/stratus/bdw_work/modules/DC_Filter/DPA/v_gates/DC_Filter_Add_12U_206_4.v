...
// Generated on: May  5 2021 00:33:51 CST (May  4 2021 16:33:51 UTC)

module DC_Filter_Add_12U_206_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g258(.AN (add_21_2_n_9), .B (in1[8]), .Y
       (add_21_2_n_11));
  XNOR2X1 add_21_2_g259(.A (in1[7]), .B (add_21_2_n_7), .Y (out1[7]));
  NAND2BX1 add_21_2_g260(.AN (add_21_2_n_7), .B (in1[7]), .Y
       (add_21_2_n_9));
  AO21XL add_21_2_g261(.A0 (in1[6]), .A1 (add_21_2_n_6), .B0
       (add_21_2_n_7), .Y (out1[6]));
  NOR2X1 add_21_2_g262(.A (in1[6]), .B (add_21_2_n_6), .Y
       (add_21_2_n_7));
  ADDHX1 add_21_2_g263(.A (in1[5]), .B (add_21_2_n_3), .CO
       (add_21_2_n_6), .S (out1[5]));
  OAI2BB1X1 add_21_2_g264(.A0N (in1[4]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_3), .Y (out1[4]));
  OR2X1 add_21_2_g265(.A (in1[4]), .B (add_21_2_n_1), .Y
       (add_21_2_n_3));
  OAI2BB1X1 add_21_2_g266(.A0N (in1[3]), .A1N (in1[2]), .B0
       (add_21_2_n_1), .Y (out1[3]));
  OR2X1 add_21_2_g267(.A (in1[3]), .B (in1[2]), .Y (add_21_2_n_1));
endmodule
