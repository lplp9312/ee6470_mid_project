...
// Generated on: May  5 2021 00:46:27 CST (May  4 2021 16:46:27 UTC)

module DC_Filter_Add2i177Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  assign out1[6] = out1[11];
  assign out1[7] = 1'b1;
  CLKINVX2 g9(.A (out1[11]), .Y (out1[5]));
