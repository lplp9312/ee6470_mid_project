...
module DC_Filter_Add2i232Mul2i258Add2u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  wire csa_tree_add_32_2_groupi_n_7, csa_tree_add_32_2_groupi_n_8,
       ...
       csa_tree_add_32_2_groupi_n_14, n_3, n_4;
  assign out1[0] = 1'b0;
  assign out1[5] = out1[7];
  assign out1[6] = out1[7];
  INVX1 g8(.A (n_3), .Y (out1[3]));
  ...
  MXI2XL csa_tree_add_32_2_groupi_g191(.A
       (csa_tree_add_32_2_groupi_n_5), .B (out1[2]), .S0
       (csa_tree_add_32_2_groupi_n_14), .Y (out1[9]));
  ADDHXL csa_tree_add_32_2_groupi_g192(.A (out1[1]), .B
       (csa_tree_add_32_2_groupi_n_10), .CO
       (csa_tree_add_32_2_groupi_n_14), .S (out1[8]));
  MXI2XL csa_tree_add_32_2_groupi_g193(.A
       (csa_tree_add_32_2_groupi_n_6), .B (n_4), .S0
       (csa_tree_add_32_2_groupi_n_11), .Y (out1[11]));
  MXI2XL csa_tree_add_32_2_groupi_g194(.A
       (csa_tree_add_32_2_groupi_n_3), .B
       (csa_tree_add_32_2_groupi_n_2), .S0
       (csa_tree_add_32_2_groupi_n_0), .Y (out1[10]));
  NOR2X1 csa_tree_add_32_2_groupi_g196(.A
       (csa_tree_add_32_2_groupi_n_8), .B (asc001_7_), .Y
       (csa_tree_add_32_2_groupi_n_11));
  ADDHX1 csa_tree_add_32_2_groupi_g198(.A (n_4), .B (n_3), .CO
       (csa_tree_add_32_2_groupi_n_10), .S (out1[4]));
  NAND2X1 csa_tree_add_32_2_groupi_g199(.A
  ...
  INVX1 csa_tree_add_32_2_groupi_g202(.A (n_4), .Y
       (csa_tree_add_32_2_groupi_n_6));
  INVX1 csa_tree_add_32_2_groupi_g203(.A (out1[2]), .Y
       (csa_tree_add_32_2_groupi_n_5));
  INVXL csa_tree_add_32_2_groupi_fopt206(.A
       (csa_tree_add_32_2_groupi_n_3), .Y
       (csa_tree_add_32_2_groupi_n_2));
  INVXL csa_tree_add_32_2_groupi_fopt207(.A (n_3), .Y
       (csa_tree_add_32_2_groupi_n_3));
  NOR2BX1 csa_tree_add_32_2_groupi_g2(.AN
