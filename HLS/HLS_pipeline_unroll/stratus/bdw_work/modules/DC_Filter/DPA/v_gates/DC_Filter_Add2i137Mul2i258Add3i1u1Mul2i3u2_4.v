...
// Generated on: May  5 2021 00:34:51 CST (May  4 2021 16:34:51 UTC)

module DC_Filter_Add2i137Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  ADDHX1 csa_tree_add_35_2_groupi_g82(.A (out1[11]), .B (out1[10]), .CO
       (out1[5]), .S (out1[4]));
endmodule
