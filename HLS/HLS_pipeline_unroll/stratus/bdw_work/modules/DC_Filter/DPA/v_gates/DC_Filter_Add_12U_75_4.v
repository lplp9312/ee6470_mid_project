...
module DC_Filter_Add_12U_75_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  XNOR2X1 add_21_2_g230(.A (in1[10]), .B (add_21_2_n_13), .Y
       (out1[10]));
  NAND2BXL add_21_2_g231(.AN (add_21_2_n_13), .B (in1[10]), .Y
       (add_21_2_n_15));
  ...
  NOR2X1 add_21_2_g237(.A (in1[7]), .B (add_21_2_n_7), .Y
       (add_21_2_n_9));
  OAI2BB1X1 add_21_2_g238(.A0N (in1[6]), .A1N (add_21_2_n_5), .B0
       (add_21_2_n_7), .Y (out1[6]));
  OR2X1 add_21_2_g239(.A (in1[6]), .B (add_21_2_n_5), .Y
       (add_21_2_n_7));
  OAI2BB1X1 add_21_2_g240(.A0N (in1[5]), .A1N (add_21_2_n_3), .B0
       (add_21_2_n_5), .Y (out1[5]));
  OR2XL add_21_2_g241(.A (in1[5]), .B (add_21_2_n_3), .Y
       (add_21_2_n_5));
  OAI2BB1X1 add_21_2_g242(.A0N (in1[4]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_3), .Y (out1[4]));
  OR2XL add_21_2_g243(.A (in1[4]), .B (add_21_2_n_1), .Y
       (add_21_2_n_3));
  OAI2BB1X1 add_21_2_g244(.A0N (in1[3]), .A1N (in1[2]), .B0
       (add_21_2_n_1), .Y (out1[3]));
  OR2XL add_21_2_g245(.A (in1[3]), .B (in1[2]), .Y (add_21_2_n_1));
endmodule
