...
// Generated on: May  5 2021 00:38:42 CST (May  4 2021 16:38:42 UTC)

module DC_Filter_Add2i164Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XNOR2X1 csa_tree_add_32_2_groupi_g84(.A (out1[11]), .B
       (csa_tree_add_32_2_groupi_n_1), .Y (out1[4]));
  NAND2BX1 csa_tree_add_32_2_groupi_g85(.AN
       (csa_tree_add_32_2_groupi_n_1), .B (out1[11]), .Y (out1[5]));
  XOR2XL csa_tree_add_32_2_groupi_g86(.A (out1[9]), .B (out1[10]), .Y
       (out1[3]));
  NAND2X1 csa_tree_add_32_2_groupi_g87(.A (out1[10]), .B (out1[9]), .Y
       (csa_tree_add_32_2_groupi_n_1));
endmodule
