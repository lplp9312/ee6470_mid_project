...
// Generated on: May  5 2021 00:34:45 CST (May  4 2021 16:34:45 UTC)

module DC_Filter_Add2i146Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  ADDHX1 csa_tree_add_35_2_groupi_g95(.A (out1[10]), .B
  ...
  ADDHX1 csa_tree_add_35_2_groupi_g96(.A (out1[9]), .B (out1[8]), .CO
       (csa_tree_add_35_2_groupi_n_1), .S (out1[2]));
endmodule
