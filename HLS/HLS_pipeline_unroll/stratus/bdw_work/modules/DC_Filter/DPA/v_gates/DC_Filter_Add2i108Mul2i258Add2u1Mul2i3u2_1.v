...
// Generated on: May  5 2021 00:48:51 CST (May  4 2021 16:48:51 UTC)

module DC_Filter_Add2i108Mul2i258Add2u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  MXI2XL csa_tree_add_32_2_groupi_g156(.A (out1[11]), .B
       (csa_tree_add_32_2_groupi_n_1), .S0
       (csa_tree_add_32_2_groupi_n_3), .Y (out1[4]));
  OAI21X2 csa_tree_add_32_2_groupi_g157(.A0 (out1[9]), .A1 (out1[10]),
       .B0 (out1[11]), .Y (out1[6]));
  NOR2X1 csa_tree_add_32_2_groupi_g159(.A (out1[9]), .B (out1[10]), .Y
       (csa_tree_add_32_2_groupi_n_3));
  INVX1 csa_tree_add_32_2_groupi_g161(.A (out1[11]), .Y
