...
module DC_Filter_Add_12U_126_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g272(.AN (add_21_2_n_4), .B (in1[4]), .Y
       (add_21_2_n_6));
  AO21XL add_21_2_g273(.A0 (in1[3]), .A1 (add_21_2_n_2), .B0
       (add_21_2_n_4), .Y (out1[3]));
  NOR2X1 add_21_2_g274(.A (in1[3]), .B (add_21_2_n_2), .Y
       (add_21_2_n_4));
  ...
  OR2X1 add_21_2_g278(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
