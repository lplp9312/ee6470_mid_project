...
module DC_Filter_Add2i131Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  wire csa_tree_add_35_2_groupi_n_6, csa_tree_add_35_2_groupi_n_14,
  ...
  ADDHXL csa_tree_add_35_2_groupi_g175(.A (out1[11]), .B
       (csa_tree_add_35_2_groupi_n_6), .CO (out1[5]), .S (out1[4]));
  MXI2XL csa_tree_add_35_2_groupi_g176(.A (out1[10]), .B
       (csa_tree_add_35_2_groupi_n_3), .S0
       (csa_tree_add_35_2_groupi_n_17), .Y (out1[3]));
