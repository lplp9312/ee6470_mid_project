...
// Generated on: May  5 2021 00:37:17 CST (May  4 2021 16:37:17 UTC)

module DC_Filter_Add2i171Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  AO21XL csa_tree_add_35_2_groupi_g93(.A0 (out1[10]), .A1
       (csa_tree_add_35_2_groupi_n_3), .B0
       (csa_tree_add_35_2_groupi_n_4), .Y (out1[3]));
  NOR2X1 csa_tree_add_35_2_groupi_g94(.A (out1[10]), .B
       (csa_tree_add_35_2_groupi_n_3), .Y
       (csa_tree_add_35_2_groupi_n_4));
  ADDHX1 csa_tree_add_35_2_groupi_g95(.A (out1[9]), .B (out1[8]), .CO
