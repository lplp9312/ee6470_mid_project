...
module DC_Filter_Add2i100Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XNOR2X1 csa_tree_add_35_2_groupi_g85(.A (out1[11]), .B
       (csa_tree_add_35_2_groupi_n_1), .Y (out1[4]));
  NAND2BX1 csa_tree_add_35_2_groupi_g86(.AN
       (csa_tree_add_35_2_groupi_n_1), .B (out1[11]), .Y (out1[6]));
  XOR2XL csa_tree_add_35_2_groupi_g87(.A (out1[9]), .B (out1[10]), .Y
       (out1[3]));
  NAND2X1 csa_tree_add_35_2_groupi_g88(.A (out1[10]), .B (out1[9]), .Y
       (csa_tree_add_35_2_groupi_n_1));
endmodule
