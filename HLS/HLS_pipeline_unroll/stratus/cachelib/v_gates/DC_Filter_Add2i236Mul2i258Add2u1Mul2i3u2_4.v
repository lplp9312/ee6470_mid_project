...
module DC_Filter_Add2i236Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  XNOR2X1 csa_tree_add_32_2_groupi_g112(.A (n_4), .B
       (csa_tree_add_32_2_groupi_n_9), .Y (out1[11]));
  XNOR2X1 csa_tree_add_32_2_groupi_g113(.A (n_3), .B
  ...
  XNOR2X1 csa_tree_add_32_2_groupi_g115(.A (n_2), .B
       (csa_tree_add_32_2_groupi_n_5), .Y (out1[9]));
  NAND2BX1 csa_tree_add_32_2_groupi_g116(.AN
       (csa_tree_add_32_2_groupi_n_5), .B (n_2), .Y
       (csa_tree_add_32_2_groupi_n_7));
  XNOR2X1 csa_tree_add_32_2_groupi_g117(.A (out1[1]), .B (out1[7]), .Y
       (out1[8]));
  NAND2BX1 csa_tree_add_32_2_groupi_g118(.AN (out1[7]), .B (out1[1]),
  ...
  AO21XL csa_tree_add_32_2_groupi_g121(.A0 (n_3), .A1 (n_2), .B0
       (csa_tree_add_32_2_groupi_n_1), .Y (out1[3]));
  NOR2X1 csa_tree_add_32_2_groupi_g122(.A (n_3), .B (n_2), .Y
