...
module DC_Filter_Add_12U_46_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  OR2XL add_21_2_g268(.A (in1[3]), .B (add_21_2_n_2), .Y
       (add_21_2_n_4));
  OAI2BB1X1 add_21_2_g269(.A0N (in1[2]), .A1N (add_21_2_n_0), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2XL add_21_2_g270(.A (in1[2]), .B (add_21_2_n_0), .Y
       (add_21_2_n_2));
  OAI2BB1X1 add_21_2_g271(.A0N (in1[1]), .A1N (in1[0]), .B0
       (add_21_2_n_0), .Y (out1[1]));
  OR2XL add_21_2_g272(.A (in1[1]), .B (in1[0]), .Y (add_21_2_n_0));
endmodule
