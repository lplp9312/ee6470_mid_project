...
// Generated on: May  5 2021 00:34:18 CST (May  4 2021 16:34:18 UTC)

module DC_Filter_Add_12U_264_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g285(.AN (add_21_2_n_12), .B (in1[8]), .Y
       (add_21_2_n_14));
  AO21XL add_21_2_g286(.A0 (in1[7]), .A1 (add_21_2_n_11), .B0
       (add_21_2_n_12), .Y (out1[7]));
  NOR2X1 add_21_2_g287(.A (in1[7]), .B (add_21_2_n_11), .Y
       (add_21_2_n_12));
  ADDHX1 add_21_2_g288(.A (in1[6]), .B (add_21_2_n_8), .CO
  ...
  OAI2BB1X1 add_21_2_g293(.A0N (in1[2]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g294(.A (in1[2]), .B (add_21_2_n_1), .Y
       (add_21_2_n_2));
  ADDHX1 add_21_2_g295(.A (in1[1]), .B (in1[0]), .CO (add_21_2_n_1), .S
       (out1[1]));
endmodule
