...
module DC_Filter_Add_12U_68_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NAND2BX1 add_21_2_g268(.AN (add_21_2_n_12), .B (in1[8]), .Y
       (add_21_2_n_14));
  AO21XL add_21_2_g269(.A0 (in1[7]), .A1 (add_21_2_n_10), .B0
       (add_21_2_n_12), .Y (out1[7]));
  NOR2X1 add_21_2_g270(.A (in1[7]), .B (add_21_2_n_10), .Y
       (add_21_2_n_12));
  OAI2BB1X1 add_21_2_g271(.A0N (in1[6]), .A1N (add_21_2_n_8), .B0
       (add_21_2_n_10), .Y (out1[6]));
  OR2X1 add_21_2_g272(.A (in1[6]), .B (add_21_2_n_8), .Y
       (add_21_2_n_10));
  OAI2BB1X1 add_21_2_g273(.A0N (in1[5]), .A1N (add_21_2_n_6), .B0
       (add_21_2_n_8), .Y (out1[5]));
  OR2X1 add_21_2_g274(.A (in1[5]), .B (add_21_2_n_6), .Y
       (add_21_2_n_8));
  OAI2BB1X1 add_21_2_g275(.A0N (in1[4]), .A1N (add_21_2_n_5), .B0
       (add_21_2_n_6), .Y (out1[4]));
  OR2XL add_21_2_g276(.A (in1[4]), .B (add_21_2_n_5), .Y
       (add_21_2_n_6));
  ADDHX1 add_21_2_g277(.A (in1[3]), .B (add_21_2_n_2), .CO
       (add_21_2_n_5), .S (out1[3]));
  OAI2BB1X1 add_21_2_g278(.A0N (in1[2]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g279(.A (in1[2]), .B (add_21_2_n_1), .Y
       (add_21_2_n_2));
  ADDHX1 add_21_2_g280(.A (in1[1]), .B (in1[0]), .CO (add_21_2_n_1), .S
       (out1[1]));
endmodule
