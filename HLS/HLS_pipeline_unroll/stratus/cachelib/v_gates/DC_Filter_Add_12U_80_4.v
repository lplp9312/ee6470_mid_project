...
// Generated on: May  5 2021 00:33:06 CST (May  4 2021 16:33:06 UTC)

module DC_Filter_Add_12U_80_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  XNOR2X1 add_21_2_g250(.A (in1[10]), .B (add_21_2_n_16), .Y
       (out1[10]));
  NAND2BXL add_21_2_g251(.AN (add_21_2_n_16), .B (in1[10]), .Y
       (add_21_2_n_18));
  ...
  NOR2X1 add_21_2_g257(.A (in1[7]), .B (add_21_2_n_10), .Y
       (add_21_2_n_12));
  OAI2BB1X1 add_21_2_g258(.A0N (in1[6]), .A1N (add_21_2_n_8), .B0
       (add_21_2_n_10), .Y (out1[6]));
  OR2X1 add_21_2_g259(.A (in1[6]), .B (add_21_2_n_8), .Y
       (add_21_2_n_10));
  OAI2BB1X1 add_21_2_g260(.A0N (in1[5]), .A1N (add_21_2_n_6), .B0
       (add_21_2_n_8), .Y (out1[5]));
  OR2XL add_21_2_g261(.A (in1[5]), .B (add_21_2_n_6), .Y
       (add_21_2_n_8));
