...
module DC_Filter_Add_12U_215_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g279(.A (in1[6]), .B (add_21_2_n_8), .Y
       (add_21_2_n_10));
  OAI2BB1X1 add_21_2_g280(.A0N (in1[5]), .A1N (add_21_2_n_7), .B0
       (add_21_2_n_8), .Y (out1[5]));
  OR2X1 add_21_2_g281(.A (in1[5]), .B (add_21_2_n_7), .Y
       (add_21_2_n_8));
  ADDHX1 add_21_2_g282(.A (in1[4]), .B (add_21_2_n_4), .CO
       (add_21_2_n_7), .S (out1[4]));
  ADDHX1 add_21_2_g283(.A (in1[3]), .B (add_21_2_n_2), .CO
       (add_21_2_n_4), .S (out1[3]));
  OAI2BB1X1 add_21_2_g284(.A0N (in1[2]), .A1N (add_21_2_n_1), .B0
       (add_21_2_n_2), .Y (out1[2]));
  OR2X1 add_21_2_g285(.A (in1[2]), .B (add_21_2_n_1), .Y
       (add_21_2_n_2));
  ADDHX1 add_21_2_g286(.A (in1[1]), .B (in1[0]), .CO (add_21_2_n_1), .S
       (out1[1]));
endmodule
