...
module DC_Filter_Add_12U_274_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2XL add_21_2_g274(.A (in1[7]), .B (add_21_2_n_11), .Y
       (add_21_2_n_12));
  ...
  OR2X1 add_21_2_g278(.A (in1[4]), .B (add_21_2_n_4), .Y
       (add_21_2_n_6));
  OAI2BB1X1 add_21_2_g279(.A0N (in1[3]), .A1N (add_21_2_n_2), .B0
       (add_21_2_n_4), .Y (out1[3]));
  OR2X1 add_21_2_g280(.A (in1[3]), .B (add_21_2_n_2), .Y
       (add_21_2_n_4));
