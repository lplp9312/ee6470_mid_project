...
module DC_Filter_Add_12U_253_4(in1, out1);
  input [11:0] in1;
  output [11:0] out1;
  wire [11:0] in1;
  wire [11:0] out1;
  ...
  NOR2X1 add_21_2_g256(.A (in1[7]), .B (add_21_2_n_10), .Y
       (add_21_2_n_11));
  ADDHX1 add_21_2_g257(.A (in1[6]), .B (add_21_2_n_7), .CO
       (add_21_2_n_10), .S (out1[6]));
  ADDHX1 add_21_2_g258(.A (in1[5]), .B (add_21_2_n_5), .CO
       (add_21_2_n_7), .S (out1[5]));
  ADDHX1 add_21_2_g259(.A (in1[4]), .B (add_21_2_n_3), .CO
