...
// Generated on: May  5 2021 00:38:49 CST (May  4 2021 16:38:49 UTC)

module DC_Filter_Add2i152Mul2i258Add2u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  OAI2BB1X1 csa_tree_add_32_2_groupi_g83(.A0N (out1[11]), .A1N
       (out1[10]), .B0 (out1[5]), .Y (out1[4]));
  OR2X1 csa_tree_add_32_2_groupi_g84(.A (out1[11]), .B (out1[10]), .Y
       (out1[5]));
endmodule
