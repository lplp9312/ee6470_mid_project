...
module DC_Filter_Add2i120Mul2i258Add3i1u1Mul2i3u2_4(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  OAI2BB1X1 csa_tree_add_35_2_groupi_g85(.A0N (out1[11]), .A1N
       (out1[10]), .B0 (out1[7]), .Y (out1[4]));
  OR2X1 csa_tree_add_35_2_groupi_g86(.A (out1[11]), .B (out1[10]), .Y
       (out1[7]));
endmodule
