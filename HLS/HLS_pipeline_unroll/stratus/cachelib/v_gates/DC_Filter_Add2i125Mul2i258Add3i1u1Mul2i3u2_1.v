...
// Generated on: May  5 2021 00:43:46 CST (May  4 2021 16:43:46 UTC)

module DC_Filter_Add2i125Mul2i258Add3i1u1Mul2i3u2_1(in2, in1, out1);
  input [1:0] in2;
  input in1;
  output [11:0] out1;
  wire [1:0] in2;
  ...
  CLKINVX2 g11(.A (out1[7]), .Y (out1[6]));
  ...
  CLKINVX4 csa_tree_add_29_2_groupi_g93(.A (in1), .Y
  ...
  MXI2XL csa_tree_add_35_2_groupi_g155(.A
       (csa_tree_add_35_2_groupi_n_2), .B (out1[11]), .S0
       (csa_tree_add_35_2_groupi_n_3), .Y (out1[4]));
  NAND2X2 csa_tree_add_35_2_groupi_g156(.A
       (csa_tree_add_35_2_groupi_n_2), .B
       (csa_tree_add_35_2_groupi_n_3), .Y (out1[7]));
  MXI2XL csa_tree_add_35_2_groupi_g157(.A (out1[9]), .B
       (csa_tree_add_35_2_groupi_n_1), .S0 (out1[10]), .Y (out1[3]));
  NOR2X2 csa_tree_add_35_2_groupi_g158(.A (out1[9]), .B (out1[10]), .Y
       (csa_tree_add_35_2_groupi_n_3));
  INVX1 csa_tree_add_35_2_groupi_g159(.A (out1[11]), .Y
